...
METHOD Test_ArrayAdd() CLASS Test_Array

    Local aArrayTest := { 'a', 'b', 'c' }

    aArrayTest:ArrayAdd( { 1 , 2 , 3 } )
    ::Assert:arrayequals( { 'a', 'b', 'c', 1, 2, 3 }, aArrayTest, 'Test ArrayAdd()' )
...
METHOD Test_ArrayInsert() CLASS Test_Array      
    ...
    aArrayTest := { 'a', 'b', 'c' }
    aArrayTest:ArrayInsert( { 1 , 2 , 3 }, 2 )
    ::Assert:arrayequals( {  'a', 1, 2, 3, 'b', 'c' }, aArrayTest, 'Test ArrayInsert()' )
...
METHOD Test_GetFirst() CLASS Test_Array

    ::Assert():equals( 1, { 1, 2, 3 }:GetFirst(), 'Test Array GetFirst()')
    ::Assert():equals( 1, { 1 }:GetFirst(), 'Test Array GetFirst()')
    ::Assert():equals( Nil, {  }:GetFirst(), 'Test Array GetFirst()')
...
METHOD Test_Sort() CLASS Test_Array
    ...
    ::Assert():arrayequals( {5,4,3,2,1}, {4,3,5,1,2}:Sort () )
    ::Assert():arrayequals( {'C','B','A'}, {'B','A','C'}:Sort () )
...
METHOD Test_ToArrayHash()
    //::Assert():arrayequals( { {"A"=>1},{"B"=>2},{"C"=>3 } }, {{'A',1},{'B',2},{'C',3}}:ToArrayHash(), 'Test Array ToArrayHash')
Return( Nil )


METHOD Test_Transpose()
    ::Assert():arrayequals( {{1,3},{2,4}}, {{1,2},{3,4}}:Transpose(), 'Test Array Transpose')
    ::Assert():arrayequals( {{1,4},{2,5},{3,6}}, {{1,2,3},{4,5,6}}:Transpose(), 'Test Array Transpose')
    ::Assert():arrayequals( {{1,3,5},{2,4,6}}, {{1,2},{3,4},{5,6}}:Transpose(), 'Test Array Transpose')
Return( Nil )


METHOD Test_ValType()

    ::Assert():equals( 'A', {1}:ValType(), 'Test Array ValType()')
...
METHOD Test_Value()
    ...
    ::Assert():arrayequals( {1,2}, {1,2}:Value(), 'Test Array Value')
    ::Assert():arrayequals( {'A','B'}, {'A','B'}:Value(), 'Test Array Value')
